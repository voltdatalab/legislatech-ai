...
class Crawler:
    urls = {
        'laws-page':'https://www.planalto.gov.br/ccivil_03/Constituicao/quadro_DEC.htm',
    }
    ...
    def _initialize_session_with_playwright(self):
        ...
        url_to_visit = self.urls['laws-page']
    ...
    def parse_link(self, data_rows:list, progress_bar)->None:
        for data_row in data_rows:
            ...
            link = self.urls['laws-page'].replace('quadro_emc.htm', link)
    ...
    def parse_link_with_workers(self, data_rows:list, workers:int = 1):
    ...
    def parse_year_pages(self, workers:int=10):
        ...
        def run_parse_link(url, is_first_time:bool = True):
            ...
            #table_div = soup.find('center')
            table = soup.find('table', {"height":"11"})
            if table:
        ...
        run_parse_link(self.urls['laws-page'])
