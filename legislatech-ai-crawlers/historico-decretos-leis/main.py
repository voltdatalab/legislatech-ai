...
class Crawler:
    urls = {
        'years-page':'https://www4.planalto.gov.br/legislacao/portal-legis/legislacao-1/decretos-leis'
    }
    ...
    def parse_link_with_workers(self, data_rows:list, year:str, workers:int = 10):
